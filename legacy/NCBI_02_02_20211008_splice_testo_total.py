...
A_dict={}
for i in range(1,96):#這裡的66是由13108/200=65.54來的
    A_list_name="A"+str(i)+"_95"
    #print(A_list_name)
    #如A1_88:
...
"""
#dict to csv
with open(load_file_dir+"splice200_testo.csv","w") as file:
...
#dict to txt
with open(load_file_dir+"splice200_testo_total.txt","w") as file:
