...
#要做自己切目錄
#keyword
Load_file_dir="C:/PYTHON/Download_Seq_files/genbank/20211014_keyword/total/"
Save_file_dir="C:/PYTHON/Download_Seq_files/gb_csv/keyword/"

#kuofile
#Load_file_dir="C:/PYTHON/Download_Seq_files/genbank/20211012_union_kuofile/total/"
#Save_file_dir="C:/PYTHON/Download_Seq_files/gb_csv/kuofile/"

#testo_total
#Load_file_dir="C:/PYTHON/Download_Seq_files/genbank/20211014_union_testo/total/"
#Save_file_dir="C:/PYTHON/Download_Seq_files/gb_csv/testo_total/"
...
for item in filename:
    ...
    lable=cate.keys()
    text=cate.values()
    with open(Save_file_dir+item[:-3]+"_gb.csv","w",newline='') as file:
